...
public partial class job : System.Web.UI.Page
{
    ...
    protected void Govtjoblinkbtn_Click(object sender, EventArgs e)
    {
        string commandtext = (sender as LinkButton).Text;
        Response.Redirect("~/Pages/" + commandtext + ".aspx");
    }


    protected void Privatelinkbtn_click(object sender, EventArgs e)
    {
